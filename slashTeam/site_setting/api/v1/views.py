...
from .serializers import SiteSerializer, SiteMetaSerializer, SiteContactInformation
...
class SiteContactInformationView(RetrieveAPIView):
    """
    for return site detail information
    """
    queryset = Site.objects.all()
    serializer_class = SiteContactInformation
